        ...
        <div className="flex flex-col h-full bg-transparent">
            ...
            <div className="p-3 sm:p-4 border-t border-surface-highlight bg-midnight/30 space-y-2">
                {user ? (
                    ...
                    >
                        <div className="h-8 w-8 sm:h-9 sm:w-9 rounded-sm border border-agent-user/40 bg-agent-user/12 flex items-center justify-center text-content-strong font-semibold text-sm overflow-hidden">
